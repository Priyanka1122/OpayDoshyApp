...
export default class settledBillDetails extends React.Component {
  constructor(props) {
    super(props);
    ...
    setTimeout(() => {
      this.setState({ balance: this.state.data.offerPrice,   balanceOldValue:  this.state.data.offerPrice})
    }, 1000);
              ...
              <View
                          ...
                          <View
                            ...
                            <View
                              ...
                              <View
                                ...
                                <TextView
                                  textValue={`$${JSON.parse(this.props.data).amount_paid}`}
                                  textStyle={{
                                    fontFamily: 'OpenSans-SemiBold',
                                    color: R.color.lightgrey,
                                    fontSize: 14,
                ...
                <View style={{paddingHorizontal: 10, paddingVertical: 12}}>
                  ...
                  <TextInput
                    ...
                    maxLength={180}
                    minHeight={60}
                    value={JSON.parse(this.props.data).Notes}
