...
var setThemeContext = function setThemeContext(ExternalThemeContext) {
  exports.ThemeContext = ExternalThemeContext;
};
...
var ThemeProvider = function ThemeProvider(_ref) {
  ...
  return React__default.createElement(exports.ThemeContext.Provider, {
    value: theme
  }, React__default.createElement(React__default.Fragment, null, reactNative.Platform.OS === 'web' ? React__default.createElement("style", {
...
var plattformIsWeb = reactNative.Platform.OS === 'web';
...
var createStyleObject = function createStyleObject(cssDeclaration) {
  ...
  if (!styleObject) {
    styleObject = Object.assign.apply(Object, [{}].concat(cssDeclaration.split(';').map(function (rule) {
      ...
      try {
        return cssToReactNative.getStylesForProperty(cssToReactNative.getPropertyName(name), resolvedValue);
      } catch (e) {
...
var useStyleSheet = function useStyleSheet(styles, theme, windowDimensions) {
  return React.useMemo(function () {
    ...
    return reactNative.StyleSheet.create(finalStyles);
  ...
  return function (strings) {
    ...
    if (expressions.every(function (exp) {
      ...
      _ref2, ref) {
        ...
        return React__default.createElement(Component, Object.assign({}, filterComponentProps(transformedProps), styleProps, {
          ref: ref
        }), children);
      };
    } else {
      ...
      _ref3, ref) {
        ...
        var cssString = React.useMemo(function () {
    ...
    return React.memo(React.forwardRef(StyledForwardRefRenderFunction));
  };
};
...
var useLengthAttribute = function useLengthAttribute(margin) {
  var theme = useTheme();
  var windowDimensions = reactNative.useWindowDimensions();
  return React.useMemo(function () {
...
styled.View = /*#__PURE__*/styled(reactNative.View, /*#__PURE__*/makePropsFilter(viewProps, domProps));
styled.Text = /*#__PURE__*/styled(reactNative.Text, /*#__PURE__*/makePropsFilter(textProps, domProps));
styled.Image = /*#__PURE__*/styled(reactNative.Image, /*#__PURE__*/makePropsFilter(imageProps, domProps));
styled.ScrollView = /*#__PURE__*/styled(reactNative.ScrollView, /*#__PURE__*/makePropsFilter(listProps, domProps));
styled.FlatList = /*#__PURE__*/styled(reactNative.FlatList, /*#__PURE__*/makePropsFilter(listProps, domProps));
styled.SectionList = /*#__PURE__*/styled(reactNative.SectionList, /*#__PURE__*/makePropsFilter(listProps, domProps));
styled.TouchableOpacity = /*#__PURE__*/styled(reactNative.TouchableOpacity, /*#__PURE__*/makePropsFilter(pressableProps, domProps));
styled.TextInput = /*#__PURE__*/styled(reactNative.TextInput, /*#__PURE__*/makePropsFilter(inputProps, viewProps, textProps, domProps));
styled.SafeAreaView = /*#__PURE__*/styled(reactNative.SafeAreaView, /*#__PURE__*/makePropsFilter(viewProps, domProps));
...
exports.setThemeContext = setThemeContext;
exports.useColorAttribute = useColorAttribute;
exports.useLengthAttribute = useLengthAttribute;
exports.useStyle = useStyle;
exports.useTheme = useTheme;
exports.withTheme = withTheme;
//# sourceMappingURL=styled-native-components.cjs.development.js.map
